<template>
	<view>
		...
		<view class="rows pl pr" v-if="system == 'android'">
		...
		<view class="rows pl pr" v-if="system == 'ios'">
			<view class="plus-box text-center-hv cols" :class="[month=='1'?'plus-box-check':'']" @tap="onMonth"
				data-month='1'>
				<view class="text-md">1个月</view>
				<view class="text-sm">{{monthToPrice(1)}}元(1个月)</view>
		...
		<view class="box-wrap-space-around pt-lg mt-lg">
			<view v-if="system == 'android'">
				<button class="btn-primary" style="width: 400rpx !important;" @tap="btnAliPay">支付宝支付</button>
			</view>
			<view v-if="system == 'android'">
				<button class="btn-success" style="width: 400rpx !important;" @tap="btnWxPay">微信支付</button>
			</view>
			<view v-if="system == 'ios'">
				<button class="btn-dark" style="width: 400rpx !important;" @tap="btnApplePay">苹果支付</button>
			</view>
		</view>
