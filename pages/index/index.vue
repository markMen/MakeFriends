	...
	export default {
		...
		onShow() {
			this.app.getUser(user => {
				...
				let chatWebSocket = new this.app.ChatWebSocket()
				chatWebSocket.webSocketInit()
				this.app.data.webSocket = chatWebSocket
		...
		methods: {
			...
			onSearchAction(invoke) {
				//板块
				this.app.post('api/chat/chat_list?XDEBUG_SESSION_START=12570', {
