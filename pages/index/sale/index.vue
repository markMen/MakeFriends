<template>
	<view class="container">
		...
		<view class="top search-top-up">
			<view class="tui-searchbox ml mr">
				<view class="tui-search-input">
					...
					<input confirm-type="search" placeholder="请输入搜索内容" placeholder-class="tui-input-plholder" class="tui-input "
					 v-model.trim="text" />
		...
		<view class="rows">
			<view class="col-12">
				<view v-for="(item,index) in page_sale.data" :key="index" @tap="onDetail" :data-index='index' :data-id='item.id'
				 @longtap="onDetailLong_sale">
					<view class="tui-light-blue com-box com-box-right text-center-hv com-box-12">
						...
						<image v-else :src="app.upload + def_img.img_sale" mode="scaleToFill"
