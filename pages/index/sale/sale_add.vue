<template>
    <view>
        ...
        <view class="pp">
            ...
            <view class="rows pt ">
                <view class="form-text-left">图片</view>
                <view class="form-text-right">
            ...
            <view class="pt-lg">
                <button class="btn-primary" @tap="onSave">发布</button>
            </view>
        </view>
...
<script>
    export default {
        ...
        methods: {
            ...
            onSave(){
                this.app.uploadFiles('api/sale/upload', this.listPhotoLocal, uploadFiles => { //上传完成后 
                    let imgs = []
                    ...
                    this.model.type = '2'
                    this.app.postLoad('api/sale/save', {
                        ...this.model
                    }, json => {
                        if(json.code == '0'){
                            this.app.toast('发布成功')
