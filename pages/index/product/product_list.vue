<template>
    <view class="">
        ...
        <view v-for="(item,index) in page.data" :key="index" @tap="onDetail" :data-index='index' :data-id='item.id'>
            <view class="mm">
                <view class="tui-light-green com-box  text-center-hv">{{item.title}}</view>
            </view>
        </view>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            onSearch() { //搜索
                //构造
                this.page = new this.app.page('api/product/page_product_me', {
            ...
            onDetail(e){
                ...
                this.app.go('/pages/index/product/product_add',{id: id})
            },
        },
        onPullDownRefresh() {
            this.page.reload(() => {
