<template>
	<view class="">
		...
		<view class="cols pp">
			<view class="pl text-md">自我介绍:</view>
			<view class="mm pp bg-white ">
				<textarea class="text-df" :value="user.bio" @input="onInput" placeholder="请输入自我介绍"></textarea>
			</view>
		</view>
