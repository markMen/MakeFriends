<template>
    <view class="container">
        <tui-tabs :tabs="tabs" :isFixed="scrollTop>=0" :currentTab="currentTab" selectedColor="#5CD492" sliderBgColor="#5CD492"
            @change="change"></tui-tabs>
        <!--选项卡逻辑自己实现即可，此处未做处理-->
        <view :class="{'tui-order-list':scrollTop>=0}">
            <view class="mm pp" :class="[order.is_see_sale == '0'?'red-order-bg':'']" v-for="(order, order_index) in page.data" :key="order_index">
     ...
     <!--               <view class="tui-btn-ml" v-if="order.state=='4'">
                        <tui-button type="black" :plain="true" width="148rpx" height="56rpx" :size="26" shape="circle">评价晒单</tui-button>
                    </view> -->
               <!--     <view class="tui-btn-ml" @tap="onProductDetail" :data-id='order.product_id'>
                        <tui-button type="danger" :plain="true" width="148rpx" height="56rpx" :size="26" shape="circle">再次购买</tui-button>
                    </view> -->

                   <!-- <view class="tui-btn-ml" v-if="order.state=='2'" :data-index="order_index" @tap="setOrderState">
                        <tui-button type="black" :plain="true" width="148rpx" height="56rpx" :size="26" shape="circle">发货</tui-button>
                    </view> -->
					<!-- <view>点击查看详情进行发货</view> -->
					
					<view class="tui-btn-ml" @tap="onProductDetail" :data-sale_id='order.creby'>
					    <tui-button type="danger" :plain="true" width="188rpx" height="56rpx" :size="26" shape="circle">进入买家主页</tui-button>
					</view>
    ...
    export default {
        ...
        methods: {
            onReload() {
                ...
                this.page = new this.app.page('api/order/me_order_sale', {
                    state: state
                })
                this.page.next()
            },
            ...
            detail(e) {
                ...
                this.app.go('/pages/me/me_order/me_order_detail_sale', {
